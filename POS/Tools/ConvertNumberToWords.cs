...
namespace POS.Tools
{
    public sealed class ConvertNumberToWords
    {
        ...
        public ConvertNumberToWords(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
        {
        ...
        {
            return ConvertNumberToWords.ToCardinal(Numero, CultureInfo.CurrentCulture);
        }
